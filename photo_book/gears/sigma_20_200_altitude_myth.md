...
| Hostile deflection of technical questions         | Asked for basic parameters (shutter, focal length, aperture), the reply is irritation rather than data — "I'm kindly warning you; if you won't believe me, forget it" or "I'm no expert, I don't understand those details". The function is to shut down scrutiny and cement a "lots of people say it's broken" impression, not to resolve anything. |
